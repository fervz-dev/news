...
<h2><a class="azul16 nobold" href="#"><?php echo $nacional[0]['etiqueta'];?></a></h1>

<h1><a class="negro20">
  <?php echo $nacional[0]['titulo'];?></a></h1>
<h3 class="gris14 nobold"><?php echo $nacional[0]['sintesis'];?></h3>


<div class="columna" style="width:295px;">

<img src="http://www.contraparteinformativa.com/archivoFotografico/<?php echo $nacional[0]['idImagen'];?>" width="295" height="196" />
<div class="piefoto">
    <strong class="blanco11"><?php echo $nacional[0]['img_tit'];?></strong> 
    <?php echo $nacional[0]['img_desc'];?>
</div>
...
<div  class="listado-noticia">&nbsp;
<?php echo $nacional[0]['contenido'];?></div>
<span class="clear"></span>
...
?>
  <h2 class="titulo"><span><?php echo $nacional[0]['etiqueta']?></span></h2>
<?php
   $naci0=  str_replace("'","",$nacionaldos[0]['titulo']);
   $naci1=str_replace("'","",$nacionaldos[1]['titulo']);
   $naci2=str_replace("'","",$nacionaldos[2]['titulo']);
    ?>
    <ul class="item-columna">
    <li><strong class="negro12"><a href="<?php echo base_url();?>index.php/internas/nacional/<?php echo $naci0;?>/<?php echo $nacionaldos[0]['idNoticia'];?>"><?php echo $nacionaldos[0]['titulo'];?></a></strong><br />
      <strong class="azul12"><?php echo $nacionaldos[0]['fecha'];?></strong> · <strong><?php echo $nacionaldos[0]['coment'];?>  Comentarios</strong><br />
    
    
    <li><strong class="negro12"><a href="<?php echo base_url();?>index.php/internas/nacional/<?php echo $naci1;?>/<?php echo $nacionaldos[1]['idNoticia'];?>"><?php echo $nacionaldos[1]['titulo'];?></a></strong><br />
      <strong class="azul12"><?php echo $nacionaldos[1]['fecha'];?></strong> · <strong><?php echo $nacionaldos[1]['coment'];?>  Comentarios</strong><br />
    
    
    <li><strong class="negro12"><a href="<?php echo base_url();?>index.php/internas/nacional/<?php echo $naci2;?>/<?php echo $nacionaldos[2]['idNoticia'];?>"><?php echo $nacionaldos[2]['titulo'];?></a></strong><br />
      <strong class="azul12"><?php echo $nacionaldos[2]['fecha'];?></strong> · <strong><?php echo $nacionaldos[2]['coment'];?>  Comentarios</strong><br />
