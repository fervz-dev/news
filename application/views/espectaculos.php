...
<h2><a class="azul16 nobold" href="#"><?php echo $espectaculo[0]['etiqueta'];?></a></h1>

<h1><a class="negro20"><?php echo $espectaculo[0]['titulo'];?></a></h1>
  <h3 class="gris14 nobold"><?php echo $espectaculo[0]['sintesis'];?></h3>
...
<img src="http://www.contraparteinformativa.com/archivoFotografico/<?php echo $espectaculo[0]['idImagen'];?>" width="295" height="196" />
<div class="piefoto">
    <strong class="blanco11"><?php echo $espectaculo[0]['img_tit'];?></strong> 
    <?php echo $espectaculo[0]['img_desc'];?>
</div>
<div class="tool">
...
<div  class="listado-noticia">&nbsp;
<?php echo $espectaculo[0]['contenido'];?>
    </div>
<span class="clear"></span>
...
?>
  <h2 class="titulo"><span><?php echo $espectaculo[0]['etiqueta']?></span></h2>
 <?php
   $esp0=  str_replace("'","",$espectaculodos[0]['titulo']);
   $esp1=str_replace("'","",$espectaculodos[1]['titulo']);
   $esp2=str_replace("'","",$espectaculodos[2]['titulo']);
    ?>
    <ul class="item-columna">
    <li><strong class="negro12"><a href="<?php echo base_url();?>index.php/internas/espectaculo/<?php echo $espectaculodos[0]['titulo'];?>/<?php echo $espectaculodos[0]['idNoticia'];?>"><?php echo $espectaculodos[0]['titulo'];?></a></strong><br />
      <strong class="azul12"><?php echo $espectaculodos[0]['fecha'];?></strong> · <strong><?php echo $espectaculodos[0]['coment'];?>  Comentarios</strong><br />
    
    
    <li><strong class="negro12"><a href="<?php echo base_url();?>index.php/internas/espectaculo/<?php echo $espectaculodos[1]['titulo'];?>/<?php echo $espectaculodos[1]['idNoticia'];?>"><?php echo $espectaculodos[1]['titulo'];?></a></strong><br />
      <strong class="azul12"><?php echo $espectaculodos[1]['fecha'];?></strong> · <strong><?php echo $espectaculodos[1]['coment'];?>  Comentarios</strong><br />
    
    
    <li><strong class="negro12"><a href="<?php echo base_url();?>index.php/internas/espectaculo/<?php echo $espectaculodos[2]['titulo'];?>/<?php echo $espectaculodos[2]['idNoticia'];?>"><?php echo $espectaculodos[2]['titulo'];?></a></strong><br />
      <strong class="azul12"><?php echo $espectaculodos[2]['fecha'];?></strong> · <strong><?php echo $espectaculodos[2]['coment'];?>  Comentarios</strong><br />
