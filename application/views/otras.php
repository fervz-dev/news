...
<h2><a class="azul16 nobold" href="#"><?php echo $otras[0]['etiqueta'];?></a></h2>


<h1><a class="negro20"><?php echo $otras[0]['titulo'];?></a></h1>
  <h3 class="gris14 nobold"><?php echo $otras[0]['sintesis'];?></h3>


<div class="columna" style="width:295px;">
    
<img src="http://www.contraparteinformativa.com/archivoFotografico/<?php echo $otras[0]['idImagen'];?>" width="295" height="196" />
<div class="piefoto">
    <strong class="blanco11"><?php echo $otras[0]['img_tit'];?></strong> 
    <?php echo $otras[0]['img_desc'];?>
</div>
...
<span class="clear"></span>
 ...
 <div id="cont" class="columna">&nbsp;
<?php echo $otras[0]['contenido'];?>
    </div>
<span class="clear"></span>
...
<div class="columnhome" style="width:296px; margin-right:0px;">
  ...
  <h2 class="titulo"><span><?php echo $otras[0]['etiqueta']?></span></h2>

    <ul class="item-columna">
        <?php
   $otra0=  str_replace("'","",$otrasdos[0]['titulo']);
   $otra1=str_replace("'","",$otrasdos[1]['titulo']);
   $otra2=str_replace("'","",$otrasdos[2]['titulo']);
  
    ?>
        
        <li><strong class="negro12"><a href="<?php echo base_url();?>index.php/internas/otras/<?php echo $otra0;?>/<?php echo $otrasdos[0]['idNoticia'];?>/<?php echo $otrasdos[0]['idRubro'];?>"><?php echo $otrasdos[0]['titulo'];?></a></strong><br />
      <strong class="azul12"><?php echo $otrasdos[0]['fecha'];?></strong> · <strong><?php echo $otrasdos[0]['coment'];?>  Comentarios</strong><br />
    
        <li><strong class="negro12"><a href="<?php echo base_url();?>index.php/internas/otras/<?php echo $otra1;?>/<?php echo $otrasdos[1]['idNoticia'];?>/<?php echo $otrasdos[1]['idRubro'];?>"><?php echo $otrasdos[1]['titulo'];?></a></strong><br />
      <strong class="azul12"><?php echo $otrasdos[1]['fecha'];?></strong> · <strong><?php echo $otrasdos[1]['coment'];?>  Comentarios</strong><br />
   
    <li><strong class="negro12"><a href="<?php echo base_url();?>index.php/internas/otras/<?php echo $otra2;?>/<?php echo $otrasdos[2]['idNoticia'];?>/<?php echo $otrasdos[2]['idRubro'];?>"><?php echo $otrasdos[2]['titulo'];?></a></strong><br />
      <strong class="azul12"><?php echo $otrasdos[2]['fecha'];?></strong> · <strong><?php echo $otrasdos[2]['coment'];?>  Comentarios</strong><br />
