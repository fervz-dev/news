...
<h1><a class="rubro_interna" href="#">VIDEOS</a></h1>

<div class="titulo_interna">
  <h2 ><?php echo $ver_video[0]['titulo'];?></h2>
...
<div class="content border listado-noticia justifyText">
<div class="imacrop justifyText">
<?php echo $ver_video[0]['descripcion'];?>
</div>
...
<div class="columnhome" style="width:296px; margin-right:0px;">
  ...
  <h2 class="titulo"><span>VIDEOS</span></h2>
  
    <ul class="item-columna">
   
    <li><strong class="negro12"><a href="<?php echo base_url();?>index.php/videos_controller/videos/<?php echo $ver_videodos[0]['id']?>"><?php echo $ver_videodos[0]['titulo'];?></a></strong><br />
      <strong class="azul12"><?php echo $ver_videodos[0]['fecha'];?></strong> · <br />
   
    <li><strong class="negro12"><a href="<?php echo base_url();?>index.php/videos_controller/videos/<?php echo $ver_videodos[1]['id']?>"><?php echo $ver_videodos[1]['titulo'];?></a></strong><br />
      <strong class="azul12"><?php echo $ver_videodos[1]['fecha'];?></strong> · <br />
    
    <li><strong class="negro12"><a href="<?php echo base_url();?>index.php/videos_controller/videos/<?php echo $ver_videodos[2]['id']?>"><?php echo $ver_videodos[2]['titulo'];?></a></strong><br />
      <strong class="azul12"><?php echo $ver_videodos[2]['fecha'];?></strong> · <br />
